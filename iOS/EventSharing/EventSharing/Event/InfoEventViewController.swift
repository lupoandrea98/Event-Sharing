...
class InfoEventViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        partecipantMask.layer.borderColor = UIColor.systemBlue.cgColor
        partecipantMask.layer.borderWidth = 1
        partecipantMask.layer.cornerRadius = 10
