...
class HomeViewController: UIViewController{
    ...
    @IBOutlet weak var userLocationButton: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        let centerUserGesture = UITapGestureRecognizer(target: self, action: #selector(centerUserInMap))
        userLocationButton.isUserInteractionEnabled = true
        userLocationButton.addGestureRecognizer(centerUserGesture)
